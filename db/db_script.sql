...
CREATE DATABASE [PHP_API]
 CONTAINMENT = NONE
 -- ON  PRIMARY 
-- ( NAME = N'PHP_API', FILENAME = N'E:\SQLServer\MSSQL15.MSSQLSERVER\MSSQL\DATA\PHP_API.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 -- LOG ON 
-- ( NAME = N'PHP_API_LOG', FILENAME = N'E:\SQLServer\MSSQL15.MSSQLSERVER\MSSQL\DATA\PHP_API_log.ldf' , SIZE = 1536KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
-- GO
